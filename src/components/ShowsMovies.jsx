...
const ShowsMovies = ({ setActiveSection }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-64 h-64 bg-amber-300/10 dark:bg-amber-500/8 rounded-full blur-3xl transition-colors duration-500"></div>
      <div className="absolute bottom-20 right-10 w-64 h-64 bg-orange-300/10 dark:bg-orange-500/8 rounded-full blur-3xl transition-colors duration-500"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="w-20 sm:w-24 md:w-32 h-1 bg-gradient-to-r from-amber-500 to-orange-500 mx-auto mb-4 sm:mb-6 md:mb-8 shadow-lg"></div>
          <p className="text-ff-slate-700 dark:text-ff-slate-300 leading-relaxed max-w-2xl mx-auto text-base sm:text-lg md:text-xl px-4">
            <span className="text-amber-600 dark:text-amber-400 opacity-80 font-mono">[</span>
              My favorite shows and movies that inspire my creativity and storytelling.
            <span className="text-orange-600 dark:text-orange-400 opacity-80 font-mono">]</span>
          </p>
        </div>
        ...
        <div className="space-y-6 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-hide">
              <div className="min-w-[220px] lg:min-w-0 bg-white dark:bg-ff-slate-800 border-2 border-amber-200 dark:border-amber-700 rounded-xl p-3 shadow-lg shadow-ff-slate-300 dark:shadow-ff-slate-900/50 transition-all duration-500">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-hide">
              <div className="min-w-[220px] lg:min-w-0 bg-white dark:bg-ff-slate-800 border-2 border-orange-200 dark:border-orange-700 rounded-xl p-3 shadow-lg shadow-ff-slate-300 dark:shadow-ff-slate-900/50 transition-all duration-500">
                <div className="flex items-center gap-3">
                  <div 
                    className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg ring-2 ring-white/20"
          ...
          {/* Genres Section - Mobile: Compact */}
          <div className="space-y-4 lg:space-y-6">
            <h3 className="text-2xl lg:text-2xl font-bold text-amber-700 dark:text-amber-300 font-sixtyfour">
              GENRES
            </h3>
            <div className="bg-white dark:bg-ff-slate-800 border-2 border-amber-200 dark:border-amber-700 rounded-xl p-4 shadow-lg shadow-ff-slate-300 dark:shadow-ff-slate-900/50 transition-all duration-500">
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full text-xs font-mono">Anime</span>
                <span className="px-2 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-full text-xs font-mono">Sci-Fi</span>
                <span className="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full text-xs font-mono">Fantasy</span>
                <span className="px-2 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-full text-xs font-mono">Drama</span>
                <span className="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full text-xs font-mono">Action</span>
              </div>
            </div>
          </div>
        </div>
