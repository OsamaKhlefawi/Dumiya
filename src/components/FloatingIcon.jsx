...
export const FloatingIcon = ({ 
  ...
  <div className={`absolute bg-slate-100 dark:bg-slate-800/90 rounded-xl flex items-center justify-center shadow-lg animate-${animate} hover:scale-110 transition-all duration-500 cursor-pointer group backdrop-blur-sm border border-${borderColor} ${className}`}>
    <img 
      src={src} 
      alt={alt} 
      className="w-12 h-12 lg:w-16 lg:h-16 object-contain group-hover:animate-pulse" 
      loading="lazy" 
      decoding="async" 
    />
    {tooltip && (
