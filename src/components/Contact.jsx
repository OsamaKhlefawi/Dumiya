          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-hide">
              {socialLinks.slice(0, 3).map((social, index) => (
                <div key={index} className="min-w-[200px] lg:min-w-0 bg-white dark:bg-ff-slate-800 border-2 border-amber-200 dark:border-amber-700 rounded-xl p-3 shadow-lg shadow-ff-slate-300 dark:shadow-ff-slate-900/50 transition-all duration-500">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-hide">
              {socialLinks.slice(3).map((social, index) => (
                <div key={index} className="min-w-[200px] lg:min-w-0 bg-white dark:bg-ff-slate-800 border-2 border-orange-200 dark:border-orange-700 rounded-xl p-3 shadow-lg shadow-ff-slate-300 dark:shadow-ff-slate-900/50 transition-all duration-500">
                  <div className="flex items-center gap-3">
                    <div 
                      className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg ring-2 ring-white/20"
